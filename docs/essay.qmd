...
![Five-year rolling average of LC US literature books by place of publication](../results/lc_ps_city.png){#fig-count}

@fig-count shows the absolute growth in the amount of annual publishing in American literature. Note that this represents *cataloged* publications, not sales or any other measure of readership beyond what is implied by cataloging librarians' judgment. While it is quite likely that books printed in New York sold better than books printed in, say, Indianapolis (the eighth most frequent place of publication in this period), this data cannot tell us much about that disparity.

![Five-year rolling average of the percentage of LC US literature books by place of publication](../results/lc_city_year_normed.png){#fig-pct}

However, the absolute growth in publication makes it difficult to see the changing geographies of US imprints. Measuring proportional change, as I do in @fig-pct, suggests that uncertainty as to whether Boston, Philadelphia, or New York would become the publishing capital of US literature is over as early as the 1840s, not in the post-Civil War period as is often assumed. In fact, the period after Reconstruction shows a relative decline in New York's importance.
